/**
 * @file test_vector_priority_queue.cpp
 * @brief 基于 doctest 的工业级优先队列测试套件 - 使用 vector 作为底层容器
 *
 * 测试覆盖范围:
...
TEST_SUITE("Vector Priority Queue Constructors")
{
    TEST_CASE("Default constructor creates empty priority queue")
    {
        demo::priority_queue<int, demo::vector<int>> pq;
        CHECK(pq.empty());
        CHECK(pq.size() == 0);
    }
    ...
    {
        demo::vector<int>                            vec{3, 1, 4, 1, 5, 9, 2, 6};
        demo::priority_queue<int, demo::vector<int>> pq(vec);
    ...
    {
        demo::priority_queue<int, demo::vector<int>, std::greater<int>> pq((std::greater<int>()));
        pq.push(3);
        pq.push(1);
        pq.push(4);
    ...
    {
        demo::vector<int>                                               vec{3, 1, 4, 1, 5};
        demo::priority_queue<int, demo::vector<int>, std::greater<int>> pq(vec,
                                                                           std::greater<int>());
    ...
    {
        demo::vector<int>                            vec{3, 1, 4, 1, 5};
        demo::priority_queue<int, demo::vector<int>> pq(std::move(vec));
    ...
    {
        demo::vector<int>                            vec{9, 2, 8, 3, 7};
        demo::priority_queue<int, demo::vector<int>> pq(vec.begin(), vec.end());
    ...
    {
        demo::priority_queue<int, demo::vector<int>> pq1;
        pq1.push(10);
        pq1.push(20);
        pq1.push(30);

        demo::priority_queue<int, demo::vector<int>> pq2(pq1);
        CHECK(pq2.size() == 3);
        CHECK(pq2.top() == 30);
    ...
    TEST_CASE("Move constructor")
    {
        ...
        demo::priority_queue<int, demo::vector<int>> pq2(std::move(pq1));
...
TEST_SUITE("Vector Priority Queue Assignment Operators")
{
    TEST_CASE("Copy assignment operator")
    {
        ...
        pq1.push(10);
        pq1.push(20);
        demo::priority_queue<int, demo::vector<int>> pq2;
        pq2.push(100);
...
TEST_SUITE("Vector Priority Queue Element Access")
{
    TEST_CASE("top() returns const reference to top element")
    {
        ...
        const demo::priority_queue<int, demo::vector<int>>& const_pq = pq;
...
TEST_SUITE("Vector Priority Queue Capacity")
{
...
TEST_SUITE("Vector Priority Queue Modifiers")
{
    ...
    {
        demo::priority_queue<std::string, demo::vector<std::string>> pq;
        pq.emplace("hello");
        pq.emplace("world");
        pq.emplace("priority");
...
TEST_SUITE("Vector Priority Queue Edge Cases")
{
    ...
    {
        demo::priority_queue<int, demo::vector<int>, std::greater<int>> pq;
        pq.push(5);
        pq.push(3);
        pq.push(8);
        pq.push(1);
...
TEST_SUITE("Vector Priority Queue Performance")
{
