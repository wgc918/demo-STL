...
template <typename Key, typename Compare, typename Allocator>
set<Key, Compare, Allocator>::iterator::iterator() : m_node(nullptr), m_container(nullptr)
{
}
...
template <typename Key, typename Compare, typename Allocator>
inline bool set<Key, Compare, Allocator>::iterator::operator==(const iterator& other) const
{
...
template <typename Key, typename Compare, typename Allocator>
set<Key, Compare, Allocator>::const_iterator::const_iterator(Node* n, const set* container)
    : m_node(n), m_container(container)
{
}

template <typename Key, typename Compare, typename Allocator>
set<Key, Compare, Allocator>::const_iterator::const_iterator(const const_iterator& other)
    : m_node(other.m_node), m_container(other.m_container)
{
}

template <typename Key, typename Compare, typename Allocator>
set<Key, Compare, Allocator>::const_iterator::const_iterator(const iterator& other)
    : m_node(other.m_node), m_container(other.m_container)
{
}
...
set<Key, Compare, Allocator>::set(InputIt first, InputIt last, const Compare& comp)
    : m_root(nullptr), m_nil(nullptr), m_size(0), m_comp(comp), m_node_alloc()
{
    m_nil = alloc_traits::allocate(m_node_alloc, 1);
    alloc_traits::construct(m_node_alloc, m_nil);
...
template <typename Key, typename Compare, typename Allocator>
set<Key, Compare, Allocator>::set(std::initializer_list<value_type> ilist, const Compare& comp)
    : m_root(nullptr), m_nil(nullptr), m_size(0), m_comp(comp), m_node_alloc()
{
    m_nil = alloc_traits::allocate(m_node_alloc, 1);
    alloc_traits::construct(m_node_alloc, m_nil);
...
template <typename Key, typename Compare, typename Allocator>
inline set<Key, Compare, Allocator>& set<Key, Compare, Allocator>::operator=(set&& other) noexcept
{
    if (this == &other)
        return *this;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::key_compare set<Key, Compare, Allocator>::key_comp()
    const
{
    return m_comp;
}
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::const_iterator set<Key, Compare, Allocator>::begin()
    const noexcept
{
    Node* m_node = m_root;
    if (m_node != m_nil)
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::const_iterator set<Key, Compare, Allocator>::cbegin()
    const noexcept
{
    return begin();
}
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::end() noexcept
{
    return iterator(m_nil, this);
}

template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::const_iterator set<Key, Compare, Allocator>::end()
    const noexcept
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::const_iterator set<Key, Compare, Allocator>::cend()
    const noexcept
{
    return const_iterator(m_nil, this);
}
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::size_type set<Key, Compare, Allocator>::size()
    const noexcept
{
    return m_size;
}
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::size_type set<Key, Compare, Allocator>::max_size()
    const noexcept
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::insert(
...
template <typename Key, typename Compare, typename Allocator>
inline void set<Key, Compare, Allocator>::insert(std::initializer_list<value_type> ilist)
{
    for (const value_type& val : ilist)
        insert(val);
}
...
template <typename Key, typename Compare, typename Allocator>
template <typename... Args>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::emplace_hint(
...
template <typename Key, typename Compare, typename Allocator>
template <typename Compare2>
inline void set<Key, Compare, Allocator>::merge(set<Key, Compare2, Allocator>& other)
{
    insert(other.begin(), other.end());
}

template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::find(
    const key_type& key)
{
    Node* cur = find_node(key);
    return iterator(cur, this);
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::const_iterator set<Key, Compare, Allocator>::find(
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::lower_bound(
    const key_type& key)
{
    Node* cur    = m_root;
    Node* result = m_nil;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::iterator set<Key, Compare, Allocator>::upper_bound(
    const key_type& key)
{
    Node* cur    = m_root;
    Node* result = m_nil;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::build_tree(
    std::vector<value_type>& values, int left, int right, size_type depth)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::copy_node(
    Node* cur, const set& other)
{
    if (cur == other.m_nil)
        return m_nil;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::rotate_left(
    Node* m_node)
{
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::rotate_right(
    Node* m_node)
{
    Node* parent          = m_node->parent;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::find_node(
    const key_type& key)
{
    Node* cur = m_root;
    while (cur != m_nil)
...
template <typename Key, typename Compare, typename Allocator>
inline const typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::find_node(
    const key_type& key) const
{
    const Node* cur = m_root;
    while (cur != m_nil)
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::min_node(
    Node* m_node)
{
    while (m_node->left != m_nil)
        m_node = m_node->left;
...
template <typename Key, typename Compare, typename Allocator>
inline const typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::min_node(
    const Node* m_node) const
{
    while (m_node->left != m_nil)
        m_node = m_node->left;
    return m_node;
...
template <typename Key, typename Compare, typename Allocator>
inline typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::max_node(
    Node* m_node)
{
...
template <typename Key, typename Compare, typename Allocator>
inline const typename set<Key, Compare, Allocator>::Node* set<Key, Compare, Allocator>::max_node(
    const Node* m_node) const
{
    while (m_node->right != m_nil)
        m_node = m_node->right;
...
template <typename Key, typename Compare, typename Allocator>
inline bool set<Key, Compare, Allocator>::validate_properties(Node*      m_node,
