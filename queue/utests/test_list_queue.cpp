...
TEST_SUITE("List Queue Constructors")
{
    TEST_CASE("Default constructor creates empty queue")
    {
        demo::queue<int, demo::list<int>> q;
        CHECK(q.empty());
        CHECK(q.size() == 0);
    }
    ...
    TEST_CASE("Constructor with container")
    {
        ...
        demo::queue<int, demo::list<int>> q(lst);
        CHECK(q.size() == 5);
        CHECK_FALSE(q.empty());
        CHECK(q.front() == 1);
        CHECK(q.back() == 5);
    ...
    {
        demo::queue<int, demo::list<int>> q1;
        q1.push(1);
        q1.push(2);
        q1.push(3);

        demo::queue<int, demo::list<int>> q2(q1);
        CHECK(q2.size() == 3);
        CHECK(q2.front() == 1);
        CHECK(q2.back() == 3);
    ...
    TEST_CASE("Move constructor")
    {
        ...
        demo::queue<int, demo::list<int>> q2(std::move(q1));
...
TEST_SUITE("List Queue Assignment Operators")
{
    TEST_CASE("Copy assignment operator")
    {
        ...
        q1.push(1);
        q1.push(2);
        demo::queue<int, demo::list<int>> q2;
        q2.push(10);
...
TEST_SUITE("List Queue Element Access")
{
    ...
    TEST_CASE("const front() returns const reference")
    {
        ...
        const demo::queue<int, demo::list<int>>& const_q = q;
...
TEST_SUITE("List Queue Capacity")
{
...
TEST_SUITE("List Queue Modifiers")
{
    ...
    {
        demo::queue<std::string, demo::list<std::string>> q;
        q.emplace("hello");
...
TEST_SUITE("List Queue Comparison Operators")
{
    TEST_CASE("operator== compares contents")
    {
        ...
        demo::queue<int, demo::list<int>> q3;
        q3.push(1);
        q3.push(3);
...
TEST_SUITE("List Queue Edge Cases")
{
...
TEST_SUITE("List Queue Performance")
{
