...
class vector
{
    public:
        ...
        class iterator
        {
            ...
            public:
                using iterator_category = std::
                    random_access_iterator_tag;  ///< 迭代器类别（随机访问迭代器）
                using value_type = typename vector::value_type;  ///< 元素类型
                using difference_type =
                    typename vector::difference_type;          ///< 差值类型
        ...
        class const_iterator
        {
            ...
            public:
                using iterator_category = std::
                    random_access_iterator_tag;  ///< 迭代器类别（随机访问迭代器）
                using value_type =
                    const typename vector::value_type;  ///< 常量元素类型
                using reference =
                    const typename vector::value_type&;  ///< 常量引用类型
                using pointer =
                    const typename vector::value_type*;  ///< 常量指针类型
                using difference_type =
                    typename vector::difference_type;  ///< 差值类型
        ...
        iterator insert(const_iterator iter, size_type count,
                        const_reference val);
...
// ------------------------------ iterator 实现 ------------------------------
template <typename T, typename Allocator>
inline vector<T, Allocator>::iterator::iterator() noexcept : m_ptr(nullptr)
{
}
...
template <typename T, typename Allocator>
inline typename vector<T, Allocator>::const_reference
vector<T, Allocator>::const_iterator::operator[](difference_type offset) const
{
    return m_ptr[offset];
}
