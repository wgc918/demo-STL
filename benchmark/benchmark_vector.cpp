...
void run_construct(Vec&, csv_writer::CsvWriter& writer, const std::vector<int>& src, std::size_t n)
{
    // 默认构造
    {
        auto op = [&]()
...
template <typename Vec>
void run_push_back(Vec&, csv_writer::CsvWriter& writer, const std::vector<int>& src, std::size_t n)
{
    {
        auto op = [&]()
        {
...
template <typename Vec>
void run_insert(Vec&, csv_writer::CsvWriter& writer, const std::vector<int>& src, std::size_t n)
{
